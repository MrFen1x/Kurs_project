...
SECRET_KEY = 'django-insecure-vibtr9j(wqk$oupc%-d6*xlr$htsp6jg_s$gx7o^sg$arkf96$'
...
MATPLOTLIBRC = {
    'backend': 'AGG'  # Используем AGG для рендеринга в буфер
}
AUTH_USER_MODEL = 'images.User'
LOGIN_REDIRECT_URL = 'public_gallery'
